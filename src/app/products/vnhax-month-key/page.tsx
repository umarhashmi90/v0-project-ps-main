            ...
            <div className="flex min-h-screen flex-col bg-gray-50">
                ...
                <main className="flex-1 pt-24 md:pt-32">
                    <div className="container mx-auto px-4 py-8">
                        <div className="grid grid-cols-1 lg:grid-cols-[6fr,5fr] gap-8 md:gap-12 max-w-5xl mx-auto">
                            ...
                            <div className="bg-white p-4 sm:p-6 rounded-xl border border-gray-200">
                                <div className="flex justify-between items-start mb-4">
                                    <div>
                                        <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900 font-headline mt-1">{productData.name}</h1>
                                    ...
                                    <div>
                                        ...
                                        <div className="border border-gray-200 rounded-lg p-4 mt-4">
                                            <ul className="space-y-3">
                                                {productData.features.slice(0, 5).map((feature, i) => (
                        ...
                        <RelatedProducts category="pc" currentProduct="Vnhax Month Key" onPriceChange={setRelatedTotal} />
