...
export default function CartPage() {
  ...
  const subtotalUSD = useMemo(() => cartItems.reduce((acc, item) => acc + item.price * item.quantity, 0), [cartItems])
            ...
            <div className="lg:col-span-2 space-y-8">
              <div className="bg-white p-4 sm:p-6 rounded-2xl shadow-sm border">
                <div className="flex justify-between items-center mb-6">
                  <h1 className="text-xl sm:text-2xl font-bold font-headline text-gray-800">Shopping Cart</h1>
                  <Button
                    variant="ghost"
                    size="sm"
                      ...
                      >
                        <div className="flex items-start gap-4 w-full">
                          ...
                          <div className="flex-1">
                            <Link href={item.href} className="font-semibold text-gray-800 hover:text-primary">
                              {item.name}
                            </Link>
                          ...
                          <Button
                            ...
                            className="h-8 w-8 text-gray-400 hover:text-red-500 sm:hidden shrink-0"
                          >
                            <X className="w-4 w-4" />
                          </Button>
                        </div>
                        <div className="flex items-center justify-between w-full sm:w-auto mt-2 sm:mt-0">
                          ...
                          <p className="hidden sm:block font-semibold w-24 text-center">
                          ...
                          <Button
                            ...
                            size="icon"
                            onClick={() => handleRemoveItem(item.id)}
                            className="h-8 w-8 text-gray-400 hover:text-red-500 hidden sm:inline-flex"
                          >
                            <X className="w-4 w-4" />
                          </Button>
                        </div>
              ...
              <div className="bg-gray-800 text-white p-6 sm:p-8 rounded-2xl shadow-lg flex flex-col sm:flex-row items-center justify-between gap-6">
                <div className="text-center sm:text-left">
                  ...
                  <p className="text-gray-300 mt-1 text-sm sm:text-base">
                    Add extra setup & personal assistant to your order.
                  </p>
                </div>
                <Button
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border sticky top-28">
                <>
                  ...
                  <Button
                    ...
                    disabled={isProcessing || totalUSD <= 0}
                  >
