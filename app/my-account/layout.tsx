...
function SidebarNav({ hasSurprise }: { hasSurprise: boolean }) {
  ...
  const isSettingsActive =
    pathname.startsWith("/my-account/account-details") || pathname.startsWith("/my-account/billing")
  ...
  return (
    <aside className="hidden md:flex flex-col w-64 lg:w-72 border-r bg-white shrink-0">
      ...
      <nav className="flex-1 px-4 space-y-2">
        {navItems.map((item) => {
          const isActive =
            item.href === "/my-account/account-details"
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive ? "bg-primary/10 text-primary" : "hover:bg-gray-100 hover:text-gray-900",
      ...
      <div className="p-4 border-t">
        <Button
          variant="ghost"
          className="w-full justify-start gap-3 text-gray-600 hover:bg-gray-100 hover:text-gray-900 text-sm"
        ...
        <main className="flex-1 pt-24 md:pt-32">
          <div className="container py-8">
            <div className="md:hidden mb-6 flex items-center justify-between">
              ...
              {isSettingsPage && <div className="text-2xl font-bold font-headline">Settings</div>}
            </div>
            <div className="bg-white rounded-xl border flex">
              ...
              <div className="flex-1 p-6 md:p-8 min-w-0">
                ...
                <div className={cn(isSettingsPage ? "mt-8" : "")}>{children}</div>
              </div>
            </div>
          </div>
        </main>
