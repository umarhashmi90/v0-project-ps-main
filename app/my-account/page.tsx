    ...
    <div>
      <div className="mb-8">
        ...
        <p className="mt-2 text-muted-foreground">
          From your dashboard you can view your recent orders, manage your shipping and billing addresses, and edit your
          ...
          <Link href={card.href} key={card.title} className="group">
            <Card className="h-full transition-all duration-300 hover:shadow-lg hover:border-primary/20 bg-gray-50/50">
              <CardHeader className="flex flex-row items-center gap-4 space-y-0 p-4 sm:p-6">
                <div className="p-3 bg-primary/10 rounded-lg">{card.icon}</div>
